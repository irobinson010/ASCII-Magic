...
The web GUI has a matching **Video** tab: pick a file, set width/fps/frame cap, press Render (video renders take a few seconds — no live auto-render), preview the animated result, and download `.gif` or `.frames`.
